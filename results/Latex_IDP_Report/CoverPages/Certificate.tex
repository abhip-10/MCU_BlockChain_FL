...
\begin{tabular}{p{0.4\textwidth}p{0.2\textwidth}p{0.4\textwidth}}
	& & \\
	& & \\
	\multicolumn{3}{c}{\printGuideNameA} \\
	\multicolumn{3}{c}{Guide \& Professor, Dept.\ of CSE} \\
	& & \\
	& & \\
	& & \\
	\centering{\printDA} & & \multicolumn{1}{c}{\printPrincipal} \\
	\centering{Dean Academics} & & \multicolumn{1}{c}{Principal} \\
	& & \\
\end{tabular}%
%	}
\end{table}
...
\begin{tabular}{ccc}
	\Large &&\\
		& &\\
	\large Guide &\large HOD &\large Principal\\
	& &\\
